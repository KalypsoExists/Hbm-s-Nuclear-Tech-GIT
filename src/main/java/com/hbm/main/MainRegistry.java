...
import com.hbm.content.loaders.ContentLoader;
...
import com.wocteams.EventHandler;
...
public class MainRegistry {
	...
	public static ToolMaterial tMatCard = EnumHelper.addToolMaterial("KEY_CARD", 0, 3, 1.0F, 0.0F, 0);
	...
	public void PreLoad(FMLPreInitializationEvent PreEvent) {
		...
		ContentLoader.registerDefaultHandlers();

		ModItems.mainRegistry();
		CustomItems.mainRegistry();

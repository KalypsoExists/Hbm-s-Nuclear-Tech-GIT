...
public class GUIMachineCardReader extends GuiInfoContainer {

	private static ResourceLocation texture = new ResourceLocation(RefStrings.MODID + ":custom/textures/gui/gui_card_reader.png");
	private TileEntityMachineCardReader reader;

	public GUIMachineCardReader(InventoryPlayer invPlayer, TileEntityMachineCardReader te) {
		super(new ContainerMachineCardReader(invPlayer, te));
		reader = te;
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 152, guiTop + 35, 16, 16, mouseX, mouseY, text);
	}
...
/*
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		String name = reader.hasCustomInventoryName() ? reader.getInventoryName() : I18n.format(reader.getInventoryName());
		name += (" (Level: " + reader.level + ")");
